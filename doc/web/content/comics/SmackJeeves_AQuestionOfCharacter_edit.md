title: Edit SmackJeeves/AQuestionOfCharacter
...
<tr>
<th>Description</th><td><textarea name="description" cols="40" rows="3">Authors ([23/25]); Slash Segary Shard kitsune fire Zmanwarrior BreakerLOLZ Snurple-the-Hedgehog Ultimate the Hedgehog AnXjak Fuzzy Fox aqua the hedgie Royle McCulloch Scar M.Dailey DelSoul 55dubdub Nick Cypher The Flames EclipseTC Punchy GrovyleGoodbye128 Kaizuto Syogren Azure_Kite Light-Called-Hope -----PLACES OPEN UP EVERY SUNDAY AT 7PM EST IF ANYONE LEAVES/A PLACE IS MADE AVAILABLE----- THERE ARE CURRENTLY: 2 SLOT(S) AVAILABLE. IF YOU WISH TO APPLY FOR A SPOT, PLEASE SEND IN AN APPLICATION, EITHER VIA THE APP SYSTEM OR VIA PM TO ZMAN OR SHARD. YOUR APP MUST INCLUDE YOUR REASON FOR WANTING TO JOIN AS WELL AS AN EXAMPLE OF (COMIC) WORK YOU'VE DONE IN THE PAST. REMEMBER, WE WORK ON A 'FIRST COME FIRST SERVED' BASIS, SO IF YOU DON'T MAKE IT THIS TIME, FEEL FREE TO TRY AGAIN IN FUTURE!</textarea></td>
</tr>
<tr>
