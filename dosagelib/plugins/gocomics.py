...
add('Annie', '/annie')
add('Apocalypseharry', '/apocalypseharry')
...
add('BETWEENTHELINES', '/between-the-lines')
add('BUNS', '/buns')
...
add('BatkidandBatrat', '/batkid-and-batrat')
...
add('MaggiesComics', '/maggies-comics')
...
add('OfMiceandMud', '/of-mice-and-mud')
...
add('OysterWar', '/oyster-war')
add('PCandPixel', '/pcandpixel')
add('PIGGENS', '/piggens')
add('PIGTIMES', '/pigtimes')
add('PS', '/ps')
