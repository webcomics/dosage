...
add('BrawlintheFamily', 'http://brawlinthefamily.keenspot.com/', 'A lovingly nostalgic and adorable parody of classic video game characters, focusing primarily on the world of Nintendo and the SMASH BROS. games.')
...
add('CountYourSheep', 'http://countyoursheep.keenspot.com/', "Can't sleep? Join Katie and her mother Laurie as they count sheep. REALLY cute sheep!")
add('CrowScare', 'http://crowscare.keenspot.com/', 'Three words: giant killer crow.')
add('Dreamless', 'http://dreamless.keenspot.com/', "A girl from America and a boy from Japan, born on the same day in 1923, can experience each others' lives as they sleep.")
add('EV', 'http://plusev.keenspot.com/', 'Poker is a way of life! Follow the adventures of an online poker pro named Corbin and his strange family and stranger friends.')
...
add('Exposure', 'http://exposure.keenspot.com/', "Following the exploits of two sexy paranormal investigators as they tackle the hidden menaces and monsters that plague a world that doesn't even believe in their existence.")
...
add('Flipside', 'http://flipside.keenspot.com/', 'An online fantasy manga following two women: Maytag, a nymphomaniac jester with split personalities; and Bernadette, a deadly-cool swordswoman. This is a comic about relationships and compromise.')
...
add('HerobyNight', 'http://herobynight.keenspot.com/', 'Jack King discovers the hidden lair and belongings of a long lost super hero from the mid-20th century. Will he suit up and take over the mantle of Hero by Night, or will he sell everything to the highest bidder online?')
...
add('LastBlood', 'http://lastblood.keenspot.com/', 'After zombies take over the Earth, vampires must protect the last surviving humans so they can live off their blood.')
...
#add('MysticRevolution', 'http://mysticrevolution.keenspot.com/', 'A fantasy web-manga that follows the adventures of a pyromaniac sorceress and an incompetent ninja as they journey through life, levels, and lots of alcohol in the online game world of MYSTIC REVOLUTION.')
...
add('NoRoomForMagic', 'http://noroomformagic.keenspot.com/', 'Wizards, spells, trolls, elves, fairies... Magic Mcallistair is an eleven year old living in a world full of fantasy -- and she hates it.')
...
add('PunchanPie', 'http://punchanpie.keenspot.com/', 'Following the life of Angela, a short, hot tempered, feisty twenty-something blonde, and the various situations and predicaments she gets into.')
...
add('RoadWaffles', 'http://roadwaffles.keenspot.com/', 'In a multiverse where just about anything could possibly happen, including breaking the laws of physics, most of the inhabitants who were previously content with living their mundane lives get dragged into messy storylines that break through time, space, alternate dimensions and occasionally even the fourth wall.')
...
add('Shadowbinders', 'http://shadowbinders.keenspot.com/', 'Crimson Rhen is brash, egotistical, womanizing -- and the most powerful mage in all of Belatyr. Mia White is a hapless schoolgirl from our world who is sucked into his adventures courtesy of one mysterious antique ring.')
...
add('ShockwaveDarkside', 'http://shockwave.keenspot.com/', 'Prequel to the upcoming 3-D sci-fi feature film! This 3-D webcomic follows Private Sam Simms, a newly recruited medic, as he teams up with a rogue\xc2\x92s gallery of mercenaries, war dogs and assassins in some of the biggest battles of the \xc2\x91Shockwave\xc2\x92 universe.')
...
add('Supernovas', 'http://supernovas.keenspot.com/', 'The fates of four small-town teenagers were forever changed when the lights hit. Now the fate of the world rests in their hands.')
...
add('Twokinds', 'http://twokinds.keenspot.com/', "It's your traditional story of a boy and a girl... except that girl happens to be a tiger. Along with an outcast and a gender-confused wolf, they travel the world and try to keep from killing each other.")
...
add('WisdomofMoo', 'http://wisdomofmoo.keenspot.com/', 'The adventures of a merry band of boys and girls and the toys who love them! You heard that right.')
add('Yirmumah', 'http://yirmumah.keenspot.com/', 'Chronicling the life of disgruntled cartoonist Drew Price, his hot wife Calypso, their friends, and an assorted cast of spitting cobras, tap dancing asses, Drama Llamas, retarded kitties, slackers, ukuleles, coffee and lots of Guinness and Rum and coke.')
add('YouDamnKid', 'http://youdamnkid.keenspot.com/', 'You Damn Kid can best be described as "A comic strip for grown ups about being a kid" It\'s a collection of oddball relatives, friends, and those weird moments from childhood that most people forget about. MATURE CONTENT')
